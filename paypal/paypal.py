...
class PayPal:
    localfinalizar="http://localhost:8081/finalizarpago/"
    localcancel="http://localhost:8081/cancelar"

    webfinalizar="http://archivo-medico.appspot.com/finalizarpago/"
    webcancel="http://archivo-medico.appspot.com/cancelar/"    
    
    """ #PayPal utility class"""
    signature_values = {}
    API_ENDPOINT = "https://api-3t.sandbox.paypal.com/nvp"
    PAYPAL_URL = ""
    ReturnURL = localfinalizar
    ...
    def __init__(self):
        ...
        'USER' : 'dcastr_1242325586_biz_api1.homex.com.mx',
        'PWD' : '1242325594', 
        'SIGNATURE' : 'Aj3GJYb2SCz.bE-vkQ3eCkvBBO4eAIiL6BkjUugZVKJRoBEgX9HPuZxS', 
        'VERSION' : '53.0',
        }
    ...
    # API METHODS
    def SetExpressCheckout(self, amount, return_url = ReturnURL, cancel_url = CancelURL, **kwargs):
        params = {
